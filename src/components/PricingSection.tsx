      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {plans.map((plan, index) => (
            <div 
              ...
              className={`rounded-xl p-8 ${
                plan.highlighted 
                  ? 'bg-gradient-to-b from-indigo-500 to-indigo-600 shadow-xl transform scale-105 -mt-4 mb-4' 
        ...
        <div className="mt-16 max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600">
            Need something different? <a href="#contact" className="text-indigo-600 font-medium">Contact us</a> for a custom solution.
          </p>
        </div>
      </div>
    </section>
