          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 mb-6">
                ...
                <span className="block bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">Digital Experience</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#" className="bg-blue-600 text-white px-8 py-3 rounded-md hover:bg-blue-700 transition-colors text-center font-medium flex items-center justify-center">
            ...
            <div className="relative lg:pl-10">
              ...
              <div className="absolute -bottom-6 -left-6 bg-blue-600 rounded-lg p-4 shadow-lg hidden md:block">
                <div className="text-white font-bold text-xl">200%</div>
                <div className="text-blue-100 text-sm">Increased productivity</div>
              </div>
            </div>
          </div>
        </div>
