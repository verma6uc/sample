...
const HeroSection = () => {
  return (
    <section className="pt-28 pb-20 sm:pt-36 sm:pb-28 bg-gradient-to-b from-green-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 mb-6">
                ...
                <span className="block bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">Digital Experience</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#" className="bg-green-600 text-white px-8 py-3 rounded-md hover:bg-green-700 transition-colors text-center font-medium flex items-center justify-center">
            ...
            <div className="relative lg:pl-10">
              ...
              <div className="absolute -bottom-6 -left-6 bg-green-600 rounded-lg p-4 shadow-lg hidden md:block">
                <div className="text-white font-bold text-xl">200%</div>
                <div className="text-green-100 text-sm">Increased productivity</div>
              </div>
            </div>
          </div>
        </div>
