      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          <div className="lg:col-span-4">
            ...
            <p className="mt-4 text-gray-400 max-w-md">
              The next evolution in deep linking and attribution, transforming link management from a technical utility into a strategic growth engine.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-8 lg:grid-cols-4">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link to="/case-studies" className="text-gray-400 hover:text-white">Case Studies</Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link to="/developers" className="text-gray-400 hover:text-white">Developers</Link>
                </li>
                <li>
                  <Link to="/documentation" className="text-gray-400 hover:text-white">Documentation</Link>
                </li>
                <li>
                  <Link to="/guides" className="text-gray-400 hover:text-white">Guides</Link>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} AI Link Intelligence. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
